...
const { ObjectId } = require("mongoose").Types; // Import if needed for ObjectId validation
...
exports.getRequests = async (req, res) => {
  try {
    ...
    // Validate the ID format (optional, for better error handling)
    // if (!ObjectId.isValid(id)) {
    //   return res.status(400).json({ message: "Invalid vendor ID" });
    // }

    // Find the vendor by their ID
    // const newPlan = new Vendor({
    //   "_id": "677eb68079badde22edba5e1",
    //   "subscriptionPlans": [
    //     "677eb6b179badde22edba5e3",
    //     "677eb78a79badde22edba5e5"
    //   ],
    //   "requests": [
    //     {
    //       "userId": "677eb65679badde22edba5de",
    //       "status": "pending",
    ...
    //     },
    //     {
    //       "userId": "677eb9a579badde22edba5f8",
    //       "status": "pending",
...
exports.createPlan = async (req, res) => {
  try {
    ...
    const vendorObjectId = new mongoose.Types.ObjectId(vendorId); // Create ObjectId for vendorId
    const userObjectId = new mongoose.Types.ObjectId(userId);     // Create ObjectId for userId
